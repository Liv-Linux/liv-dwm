...
static const char *scr[] = { "sh","-c","scrot -s - | xclip -selection clipboard -target image/png -i", NULL};
static const char *killx[] = {"xkill", NULL};
...
static const Key keys[] = {
  ...
  { MODKEY|ControlMask,           XK_y,      setlayout,      {.v = &layouts[3]} },
	...
	{ MODKEY|ControlMask,           XK_v,  setlayout,      {.v = &layouts[11]} },
	{ MODKEY|ControlMask,           XK_r, setlayout,      {.v = &layouts[13]} }, 
  ...
  { 0, XF86XK_AudioRaiseVolume, spawn, {.v = (const char*[]){ "amixer", "set", "Master", "5%+", NULL } } },
  { 0, XF86XK_AudioLowerVolume, spawn, {.v = (const char*[]){ "amixer", "set", "Master", "5%-", NULL } } },
